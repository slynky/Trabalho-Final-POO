...
CREATE TABLE Turma (
    ...
    data_inicio DATE,
    data_fim DATE,
    id_turma_pai INT NULL,
    FOREIGN KEY (id_turma_pai) REFERENCES Turma(id) ON DELETE SET NULL
);
...
CREATE TABLE Tarefa (
    ...
    FOREIGN KEY (id_atividade) REFERENCES Atividade(id) ON DELETE RESTRICT
);
